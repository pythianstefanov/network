 #icontrol_add_rule_universal_blocking_toall_VIPS.ps1
...
$logfile = "C:\scripts\f5logs\icontrol-add-rule_universal_blocker-$f5-$date.log"
$cred = get-credential
